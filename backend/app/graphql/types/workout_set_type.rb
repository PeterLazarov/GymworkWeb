...
module Types
  class WorkoutSetType < Types::BaseObject
    ...
    def weight
      measurement = object.exercise.exercise_measurements.to_a.find { |m| m.measurement_type == 'weight' }
    ...
    def distance
      measurement = object.exercise.exercise_measurements.to_a.find { |m| m.measurement_type == 'distance' }
      return nil unless measurement
